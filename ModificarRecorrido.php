	...
	<section class="full-box dashboard-contentPage">
		...
		<!-- Content page -->
			...
			<div class="page-header">
			  <h1 class="text-titles text-center"> &#160; &#160;Modificar Rutas</h1>
							...
							<div class="container-fluid">
								<div class="row">
									<div class="col-xs-12 col-md-10 col-md-offset-1">
									    <form method="POST" action="R-Modificar.php">
															
											<?php
											$codigo=$_REQUEST['codigo'];
											include ("Conexion.php");
											$query="SELECT * FROM recorrido WHERE codigo='$codigo'";
									   ...
									   <input class="form-control" type="number" name="codigo" value="<?php echo $row['codigo']; ?>">
					                    ...
					                    <div class="form-group label-floating">
										<label class="control-label">Nomeclatura</label>
										<input class="form-control" type="text" min="1" max="2" name="nomenclatura" value="<?php echo $row['nomenclatura']; ?>">
										</div>
                                         <div class="form-group label-floating">
										<label class="control-label">Dias de servicio</label>
										 <input class="form-control" type="text" min="2" max="4" name="dias_servicio" value="<?php echo $row['dias_servicio']; ?>">
										</div>
                                         <div class="form-group label-floating">
										<label class="control-label">Hora de servicio</label>
								 		<input class="form-control" type="text" name="horario_servicio" value="<?php echo $row['horario_servicio']; ?>">
										</div>
                                         <div class="form-group label-floating">
										<label class="control-label">Tiempo de recorrido</label>
										<input class="form-control" type="text" name="tiempo_recorrido" value="<?php echo $row['tiempo_recorrido']; ?>">
										</div>
					                    <div class="form-group">
										 <label class="control-label">Disponibilidad</label>
										 <select class="form-control" name="disponibilidad" value="<?php echo $row['disponibilidad']; ?>">
